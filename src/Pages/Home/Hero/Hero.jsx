        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 rounded-xl bg-primary opacity-50 blur-xl"></div>
              <img
                src={bitssLogo}
                alt="bitss logo"
                loading="lazy"
                className="relative size-20 rounded-xl shadow-2xl transition-transform duration-300 hover:scale-110"
              />
            </div>
          </div>
          ...
          <h5 className="text-xl md:text-3xl text-center mt-12 font-bold text-primary">Bitss <span className="text-black">for</span> </h5>
