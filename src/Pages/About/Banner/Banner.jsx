    ...
    <SectionContainer>
      <div className="flex flex-col items-center gap-8 md:flex-row md:gap-16">
        ...
        <div className="w-full md:w-1/2">
          ...
          <p className="text-muted-text mb-6 text-lg font-light md:text-xl">
          ...
          <ul className="text-muted-text mb-8 list-disc pl-6 font-light">
            <li>
          ...
          <Link
            to="/contact"
            className="hover:bg-primary-hover bg-primary inline-block rounded-full px-8 py-3 text-center text-lg font-medium text-white transition-all duration-200 ease-linear hover:shadow-[0_10px_13px_rgba(211,47,47,0.16)]"
          >
            Global Support
          </Link>
        </div>
